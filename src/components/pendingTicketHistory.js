// Component rendered to display pending tickets
...
export default class PendingTicketHistory extends React.Component {
  constructor() {
    super();
    this.state = {};
  }
        ...
        >
          ...
          >
            <TouchableOpacity
              ...
              onPress={() => {
                this.props.updateTicketStatus(data, "solved");
              }}
            >
              <Text
                style={{
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                this.props.updateTicketStatus(data, "closed");
              }}
            >
              <Text
                style={{
